 ...
 * @property string $surveyls_ccodepo Survey Case Code/ PO in this language
 * @property integer $surveyls_nsize Survey N Size in this language
...
class SurveyLanguageSetting extends LSActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('surveyls_ccodepo', 'LSYii_Validators'),
            array('surveyls_ccodepo', 'length', 'min' => 0, 'max' => 200),
            array('surveyls_nsize', 'LSYii_Validators'),
    ...
    {
        $this->db->select('a.*, surveyls_title, surveyls_ccodepo, surveyls_nsize, surveyls_description, surveyls_welcometext, surveyls_url');
