...
class QuickTranslation
{
    ...
    private static $translateFields = [
        ...
        [
            'type' => 1,
            'dbColumn' => 'surveyls_ccodepo',
            'id1' => '',
            'id2' => '',
            'gid' => false,  //boolean value to indicate if used or not
            'qid' => false,  //boolean value to indicate if used or not
            'HTMLeditorType' => "ccodepo",
            'HTMLeditorDisplay' => "Inline",
            'associated' => "" //this is the second field of the tab content
        ],
        'nsize' =>
        [
            'type' => 1,
            'dbColumn' => 'surveyls_nsize',
            'id1' => '',
            'id2' => '',
            'gid' => false,  //boolean value to indicate if used or not
            'qid' => false,  //boolean value to indicate if used or not
            'HTMLeditorType' => "nsize",
            'HTMLeditorDisplay' => "Inline",
            'associated' => "" //this is the second field of the tab content
        ],
        'description' =>
    ...
    public function updateTranslations($fieldName, $tolang, $new, $qidOrgid = 0, $answerCode = '', $iScaleID = '')
    {
        ...
        switch ($fieldName) {
            ...
            case 'ccodepo':
                return $updateLanguageSetting(array('surveyls_ccodepo' => substr((string) $new, 0, 200)));
            case 'nsize':
                return $updateLanguageSetting(array('surveyls_nsize' => $new));
            case 'description':
