    ...
    <div class="grow-10 ls-space padding left-10 right-10">
        <div>
            <div class="tab-pane active" id="texts" data-count="1">
                ...
                <div class="col-4">
                    <div class="mb-3">
                        <label for="surveyTitle"><?= gT('Project Name:') ?></label>
                    ...
                    <div class="mb-3">
                        <label for="surveyCcodepo"><?= gT('Case Code/ PO#') ?></label>
                        <input type="text" class="form-control" name="surveyls_ccodepo" id="surveyCcodepo" required="required" maxlength="200">
                        <div class="form-control-static">
                            <span class='annotation text-danger'><?php echo  gT("Required"); ?> </span>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="administrator"><?= gT("Survey Owner:") ?></label>
                        <div>
                    ...
                    <div id="conditional-administrator-fields" style="display: none;">
                        <div class="mb-3">
                            <label class="form-label" for="admin"><?= gT("Survey Owner name") ?></label>
                        ...
                        <div class="mb-3">
                            <label class=" form-label" for='adminemail'><?php eT("Survey Owner email"); ?></label>
